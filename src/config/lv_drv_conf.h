...
void LV_DRV_DELAY_US(uint32_t us);                  /*Delay the given number of microseconds*/
void LV_DRV_DELAY_MS(uint32_t ms);                  /*Delay the given number of milliseconds*/
...
void LV_DRV_DISP_CMD_DATA(bool);                     /*Set the command/data pin to 'val'*/
void LV_DRV_DISP_RST(bool);                          /*Set the reset pin to 'val'*/

/*---------
 *  SPI
 *---------*/
void LV_DRV_DISP_SPI_CS(bool);                        /*Set the SPI's Chip select to 'val'*/
void LV_DRV_DISP_SPI_WR_BYTE(uint8_t);                /*Write a byte the SPI bus*/
void LV_DRV_DISP_SPI_WR_ARRAY(char const*, unsigned); /*Write 'n' bytes to SPI bus from 'adr'*/

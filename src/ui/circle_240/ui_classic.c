...
#define ui_classic (ui.screen)
#define ui_TempIn (ui.temp_in)
#define ui_TempOut (ui.temp_out)
#define ui_HumidityIn (ui.humidity_in)
#define ui_HumidityOut (ui.humidity_out)
#define ui_PressureIn (ui.pressure_in)
#define ui_PressureOut (ui.pressure_out)
#define ui_VocIn (ui.voc_in)
#define ui_VocOut (ui.voc_out)
#define ui_Chart (ui.chart)
#define ui_ChartMax (ui.chart_max)
#define ui_XAxisScale (ui.chart_x_axis_scale)
#define ui_FanPower (ui.fan_power)
#define ui_FanRPM (ui.fan_rpm)
#define ui_TouchOverlay (ui.touch_overlay)
#define ui_FanPowerArc (ui.fan_power_arc)

NevermoreDisplayUI nevermore_ui_screen_circle_240_classic() {
    lv_obj_t* ui_Container0;
    ...
    lv_obj_t* ui_FanBox;
    lv_obj_t* ui_FanLabels;
    lv_obj_t* ui_FanPowerText;
    lv_obj_t* ui_FanRpmText;
    lv_obj_t* ui_FanValuesBox;

    NevermoreDisplayUI ui = {0};

    ui_classic = lv_obj_create(NULL);
    lv_obj_clear_flag(ui_classic, LV_OBJ_FLAG_SCROLLABLE);  /// Flags
    lv_obj_set_style_bg_color(ui_classic, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_classic, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_Container0 = lv_obj_create(ui_classic);
    lv_obj_remove_style_all(ui_Container0);
    lv_obj_set_width(ui_Container0, lv_pct(45));
    lv_obj_set_height(ui_Container0, LV_SIZE_CONTENT);  /// 1
    lv_obj_set_x(ui_Container0, lv_pct(0));
    lv_obj_set_y(ui_Container0, lv_pct(6));
    lv_obj_set_align(ui_Container0, LV_ALIGN_TOP_MID);
    lv_obj_set_flex_flow(ui_Container0, LV_FLEX_FLOW_ROW);
    lv_obj_set_flex_align(
            ui_Container0, LV_FLEX_ALIGN_SPACE_BETWEEN, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_START);
    lv_obj_clear_flag(ui_Container0, LV_OBJ_FLAG_SCROLLABLE);  /// Flags
    lv_obj_set_style_bg_color(ui_Container0, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_Container0, 0, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_PressureLabels = lv_obj_create(ui_Container0);
    lv_obj_remove_style_all(ui_PressureLabels);
    ...
    lv_label_set_text(ui_PressureIn, "--- hPa");
    ...
    lv_label_set_text(ui_PressureOut, "--- hPa");
    ...
    ui_HumidityLabels = lv_obj_create(ui_Container0);
    lv_obj_remove_style_all(ui_HumidityLabels);
    ...
    ui_ChartBox = lv_obj_create(ui_classic);
    lv_obj_remove_style_all(ui_ChartBox);
    ...
    lv_obj_remove_style_all(ui_ChartOverlay);
    ...
    lv_obj_remove_style_all(ui_ChartLabels);
    ...
    lv_obj_remove_style_all(ui_VocLabels);
    ...
    lv_obj_remove_style_all(ui_TempLabels);
    ...
    lv_label_set_text(ui_ChartMax, "100 VOC\n60c");
    ...
    ui_FanBox = lv_obj_create(ui_classic);
    lv_obj_remove_style_all(ui_FanBox);
    lv_obj_set_width(ui_FanBox, lv_pct(35));
    lv_obj_set_height(ui_FanBox, LV_SIZE_CONTENT);  /// 13
    lv_obj_set_x(ui_FanBox, 0);
    lv_obj_set_y(ui_FanBox, lv_pct(-2));
    lv_obj_set_align(ui_FanBox, LV_ALIGN_BOTTOM_MID);
    lv_obj_set_flex_flow(ui_FanBox, LV_FLEX_FLOW_ROW);
    lv_obj_set_flex_align(ui_FanBox, LV_FLEX_ALIGN_START, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_START);
    lv_obj_clear_flag(ui_FanBox, LV_OBJ_FLAG_SCROLLABLE);  /// Flags

    ui_FanLabels = lv_obj_create(ui_FanBox);
    lv_obj_remove_style_all(ui_FanLabels);
    lv_obj_set_width(ui_FanLabels, LV_SIZE_CONTENT);   /// 100
    lv_obj_set_height(ui_FanLabels, LV_SIZE_CONTENT);  /// 100
    lv_obj_set_x(ui_FanLabels, 1);
    lv_obj_set_y(ui_FanLabels, lv_pct(-5));
    lv_obj_set_align(ui_FanLabels, LV_ALIGN_CENTER);
    lv_obj_set_flex_flow(ui_FanLabels, LV_FLEX_FLOW_COLUMN);
    lv_obj_set_flex_align(ui_FanLabels, LV_FLEX_ALIGN_START, LV_FLEX_ALIGN_START, LV_FLEX_ALIGN_START);
    lv_obj_clear_flag(ui_FanLabels, LV_OBJ_FLAG_SCROLLABLE);  /// Flags
    lv_obj_set_style_text_color(ui_FanLabels, lv_color_hex(0xFF0000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_FanLabels, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_FanPowerText = lv_label_create(ui_FanLabels);
    ...
    ui_FanRpmText = lv_label_create(ui_FanLabels);
    lv_obj_set_width(ui_FanRpmText, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_FanRpmText, LV_SIZE_CONTENT);  /// 1
    lv_obj_set_align(ui_FanRpmText, LV_ALIGN_CENTER);
    lv_label_set_text(ui_FanRpmText, "RPM:");

    ui_FanValuesBox = lv_obj_create(ui_FanBox);
    lv_obj_remove_style_all(ui_FanValuesBox);
    lv_obj_set_height(ui_FanValuesBox, LV_SIZE_CONTENT);  /// 100
    lv_obj_set_flex_grow(ui_FanValuesBox, 1);
    lv_obj_set_x(ui_FanValuesBox, 1);
    lv_obj_set_y(ui_FanValuesBox, lv_pct(-5));
    lv_obj_set_align(ui_FanValuesBox, LV_ALIGN_CENTER);
    lv_obj_set_flex_flow(ui_FanValuesBox, LV_FLEX_FLOW_COLUMN);
    lv_obj_set_flex_align(ui_FanValuesBox, LV_FLEX_ALIGN_START, LV_FLEX_ALIGN_START, LV_FLEX_ALIGN_END);
    lv_obj_clear_flag(ui_FanValuesBox, LV_OBJ_FLAG_SCROLLABLE);  /// Flags

    ui_FanPower = lv_label_create(ui_FanValuesBox);
    lv_obj_set_width(ui_FanPower, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_FanPower, LV_SIZE_CONTENT);  /// 1
    lv_obj_set_align(ui_FanPower, LV_ALIGN_CENTER);
    ...
    ui_FanRPM = lv_label_create(ui_FanValuesBox);
    ...
    lv_label_set_text(ui_FanRPM, "0");
    lv_obj_set_style_text_color(ui_FanRPM, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_FanRPM, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_TouchOverlay = lv_obj_create(ui_classic);
    lv_obj_remove_style_all(ui_TouchOverlay);
    lv_obj_set_width(ui_TouchOverlay, lv_pct(100));
    lv_obj_set_height(ui_TouchOverlay, lv_pct(100));
    lv_obj_set_align(ui_TouchOverlay, LV_ALIGN_CENTER);
    lv_obj_clear_flag(ui_TouchOverlay, LV_OBJ_FLAG_SCROLLABLE);  /// Flags

    ui_FanPowerArc = lv_arc_create(ui_classic);
